...
<input type="text" name="search_connection" value="<?php if (isset($_POST['search_connection'])) echo $_POST['search_connection']; ?>" placeholder="Search Connection">
<input type="submit" name="search">
<input type="button" value="Get Connection" class="get-connection" onclick="window.location='communication.php?mode=create'">
</form>
</div>
