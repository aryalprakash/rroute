    ...
    <div class="main-content">
        ...
        <div class="content-block">
            <div class="search-connection">
                <form action="" method="post">
                    <input type="button" value="Inbox" class="inbox-btn <?php if ($mode == 'show') echo 'active'; ?>"
                           onclick="window.location='communication.php?mode=inbox'">
                    <input type="button" value="Create"
                           class="create-message-btn <?php if ($mode == 'create') echo 'active'; ?>"
                    ...
                    <input type="hidden" name="search_connection"
            ...
            <div class="create-message-block">
                <?php if ($sent) { ?>
                    <div class="form-item send-result">Your message to <?php echo $_POST['recipient'] ?> has been sent
                    </div>
                <?php } ?>
                <form id="create-message" action="" method="post">
                    <div class="form-item"><label>Recipient:</label> <input type="text" name="recipient"
                                                                            placeholder="Start to type name of recipient"
                                                                            id="recipient"></div>
                    ...
                    <div class="form-item"><input type="submit" value="Send" class="upload-next send-message-btn"
                                                  name="send"></div>
                </form>
