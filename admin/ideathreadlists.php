    ...
    <table class ="adminlist-table" id ="t02" cellpadding="0"cellspacing ="0">
        ...
        foreach ($projects as $ix=>$project){
            ...
            <tr id ="idealist_<?php echo $project['ideathread_id']; ?>">
                <td><?php echo ($ix+1);?></td>
                <td><a href="<?php echo SITE_URL."/home.php?iid=".$project['ideathread_id']; ?>"><?php echo $project['ideathread_title'];//this page need to restrict ?> </a></td>
                ...
                <td><a class=""><input type="button" data-id="<?php echo $project['ideathread_id']; ?>" class="admin-accept-ideathread accept_<?php echo $project['ideathread_id']; ?>" value ="<?php if($project['status']=='approved') echo "Reject"; else echo "Accept"; ?>"></a></td>
