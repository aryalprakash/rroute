    ...
    <table class ="adminlist-table"  id ="t02" cellpadding="0"cellspacing ="0">
        ...
        foreach ($projects as $ix=>$project){
            ...
            <tr id ="blogpostlist_<?php echo $project['post_id']; ?>">
                <td><?php echo ($ix+1);?></td>
                <td><a href="<?php echo SITE_URL."/blog.php?id=".$project['post_id']; ?>"><?php echo $project['title'];//this page need to restrict ?> <a></td>
                ...
                <td><a class=""><input type="button" data-id="<?php echo $project['post_id']; ?>"  class="admin-accept-blogpost blogpostaccept_<?php echo $project['post_id']; ?>" value ="<?php if($project['verified']=='1') echo "Reject"; else echo "Accept"; ?>"></a></td>
