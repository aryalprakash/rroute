...
<head>
    ...
    <meta
        content="Rangeenroute is a creative platform that connects people to discover, share and boost genuine ideas. With Rangeenroute, people can bring the stuffs – dreams are made of and drive them towards reality."
    ...
    <div class="header-container">
        <?php if (!empty($_SESSION['logged_in'])) { ?>
            ...
            <div class="user-bar">
                ...
                <div class="user-name-top"><a href="user.php"><?php echo ucwords($_SESSION['display_name']); ?></a>
                </div>
                ...
                <div class="popup-alerts">
                    ...
                    if ($notifications) {
                        foreach ($notifications as $n) {
                            ...
                            <div class="notify-item" <?php if ($date == $last_date) echo 'style="border: none;"'; ?>
                                 data-id="<?php echo $n['notify_id']; ?>">
                                <div
                                    class="notify-date"><?php if (!isset($last_date) || $date != $last_date) echo $date ?></div>
                                <div class="notify-text"
                                     id="notifytext_<?php echo $n['notify_id']; ?>"><?php echo $n['text'] ?></div>
                            </div></a>
        ...
        <?php } else {
            ?>
            <a href="<?php echo SITE_URL; ?>" alt="Home" class="site-logo"><img
                    src="<?php echo SITE_URL; ?>/images/logo.png"></a>
