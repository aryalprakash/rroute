...
<html lang="en-US">
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.3.0/css/font-awesome.css" type="text/css" />
        ...
        <script src="./js/file-uploading/js/jquery.iframe-transport.js"></script>
        <!-- The basic File Upload plugin -->
        <script src="./js/file-uploading/js/jquery.fileupload.js"></script>


        <link rel="stylesheet" href="./js/jquery-ui/jquery-ui-1.11.0/jquery-ui.css">
        <script src="./js/jquery-ui/jquery-ui-1.11.0/jquery-ui.js"></script>
