...
//
            ...
            <div class="funding" style="display: none; width: 100%;">
                <div class="half-left center">
                    ...
                    $ &nbsp; <input type="number" id="investment_amount" class="investment-amount-<?php echo $project['project_id']; ?>" style="padding: 5px;">
                </div>
                    ...
                    <div class="form-item thematic-box" style="padding: 10px 5px;">
                        <form>
                            <?php if ($reward == 'Equity') { ?>
                                <div class="thematic-items eq-pc-<?php echo $project['project_id']; ?>" style="width: 97%;">
                            ...
                            if ($reward == "Product") {
                                ?>
                                <div class="thematic-items final-product-<?php echo $project['project_id']; ?>" style="width: 50%;">
                                    Final Product<br/>
                                    <input type="radio" name="reward" id="product" disabled>
                                </div>
                                <div class="thematic-items users-choice-<?php echo $project['project_id']; ?>" style="width: 50%;">
                                    Users Choice<br/>
