    ...
    foreach ($ideas as $idea) {
        ...
        <div class="user-list-idea">
            ...
            <div class="thumb-img" style="float: left">
                ...
                <a href="<?php echo $source ?>" target="_blank"><img
                        src="<?php if (!empty($thumbnail)) echo $thumbnail; else echo $nophoto; ?>" height="100%"
                        width="100%"></a>
            ...
            <div class="idea-preview">
                <div class="seventy left" style="margin-bottom: -15px;">
                    <a href="<?php echo SITE_URL . '/home.php?iid=' . $ideathread_id ?>" style="text-decoration: none;">
                        <h1 class="idea-title"><?php echo $title; ?></h1></a>
                ...
                <div class="thirty right" style="">
                    <div style="width: 50%; float: left">
                        <div class="idea-stats"><a
                                href="<?php echo SITE_URL . '/home.php?iid=' . $ideathread_id ?>"><img
                                    src="./images/icons/star.jpg"/></a>
                        ...
                        <div class="idea-stats"><a
                                href="<?php echo SITE_URL . '/home.php?iid=' . $ideathread_id ?>"><img
                                    src="./images/icons/ranking.png"/></a>
                        ...
                        <div class="idea-stats"><a
                                href="<?php echo SITE_URL . '/home.php?iid=' . $ideathread_id ?>"><img
                                    src="./images/icons/like.png"/></a>

                            <div class="stat-no"><?php echo $likes ?></div>
                        </div>
                        <div class="idea-stats"><a
                                href="<?php echo SITE_URL . '/home.php?iid=' . $ideathread_id ?>"><img
                                    src="./images/icons/comment.jpg"/></a>
                    ...
                    <div style=" float: right">
                        ...
                        <div class="thumb"><a href="<?php echo SITE_URL . '/user.php?pid=' . $idea['created_by']; ?>">
                                <img src="./uploads/avatars/thumbs/<?php echo $userphoto; ?>"
                                     title="Posted by <?php echo $name ?>"></a></div>
