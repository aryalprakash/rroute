...
if ($projects) {
    ...
    foreach ($projects as $pr) {
        ...
        <div class="recent-project-item index">
            ...
            if (!empty($image)) {
                ?>
                <a href="#" class="recent-project-title index view-more" title="<?php echo $title; ?>"><img
            ...
            <div class="project-bottom-details index">
                <a href="#" class="recent-project-title index view-more"
            ...
            <div class="project-author index"><?php echo TimeAgo(date('Y-m-d', strtotime($project['created_on']))); ?>
                by <a href="#" class="view-more"><?php echo $user['display_name']; ?></a></div>
