...
if ($interactions){
	foreach ($interactions as $i){
		...
		<div style="font-size:15px; margin-bottom:10px;" >
        		...
        		<span class=""><?php echo $user.' '.$action.' '?><a href="/user.php?uid=<?php echo $i['author']?>" style="color: #FF0303; text-decoration:none;"><?php echo $author?></a><?php echo "'s ". $i['type']?> <a href="<?php echo $url?>" style="color: #FF0303; text-decoration:none;"><?php echo $title?>.<a></span>
