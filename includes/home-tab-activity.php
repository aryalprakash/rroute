...
if ($interactions){
	foreach ($interactions as $i){
		...
		<div style="font-size:15px; margin-bottom:10px;" >
        		...
        		<span class=""><?php echo $user.' '.$action.' '?><a href="<?php echo SITE_URL; ?>/user.php?uid=<?php echo $i['author']?>" style="color: #FF4F00; text-decoration:none;"><?php echo $author; ?></a><?php echo "'s ". $i['type']?> <a href="<?php echo $url;?>" style="color: #FF4F00; text-decoration:none;"><?php echo $title?>.<a></span>
