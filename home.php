        ...
        <div class="main-content home">
            <div class="profile-home-add">
                <form name="project-action"  method="post">
                    <input type="radio" name="type_project[]" id="add_project_radio" value="project"> <label for="add_project_radio">Project</label>
                    <input type="radio" style="margin-left:20%" name="type_project[]" id="add_ideaThread_radio" value="ideaThread"> <label for="add_ideaThread_radio">IdeaThread</label>
                ...
                if($showProject) {
                    ...
                    <div class="content-title">
                      <div class="router-user-photo">
                        ...
                        <a href="project_details.php?pid=<?php echo $project['project_id']; ?>" class="project-title"><?php echo $project['project_title']; ?></a>
		...
		<?php if(!isset($_GET['iid'])){ ?>
                    <div class="home-project-info">
                        ...
                        <?php if($project['created_by'] == $_SESSION['uid'] ){ ?>
                        	<span><a href="project_details.php?pid=<?php echo $project['project_id']; ?>"><img src="images/icons/stat.png"></a></span>
                       <?php } else {
                         if($project['privacy'] == 'monetized'){ ?>
                        
                        <span><a href="payment.php?pid=<?php echo $project['project_id']; ?>" class="showConfirm" data-monetize="<?php echo $project['monetize'];?>"><img src="images/icons/stat.png"></a></span>
					...
					<div id="analizeAccept" class="hidden">
						<div id="visibleArea" data-balance="<?php echo $authorizedUser['balance']; ?>" data-monetize="<?php echo $project['monetize']; ?>">
						<?php if($project['privacy'] == 'monetized'){ ?>
						<div class="slide noMoney hidden">
								<p>You have to pay <span class="chargeAmount">$<?php echo $project['monetize'] > 0 ? $project['monetize'] : ''; ?></span> to access the analysis of this project.</p>
								...
								>Accept</a> -->
								<a href="payment.php?pid=<?php echo $project['project_id'] ?>" class="btn">Accept</a>
							</div>
							<?php }
							if($project['privacy'] == 'private'){ ?>
							<div class="slide noMoney hidden" id="notifyTextContent">
								<p >You need to request the project owner for permission to access the analysis of this project.</p>
                    ...
                    <div class="project-action">
                        ...
                        <a href="#" class="project-action-btn" id="comment_project" data-id="<?php echo $project['project_id'] ?>">Comment &nbsp;<span><?php echo countComments ($project['project_id']); ?></span></a>

                        <?php if (checkLikedProject($project['project_id'], $_SESSION['uid'])) { ?>
                            <a href="#" class="project-action-btn" id="liked_project" data-id="<?php echo $project['project_id'] ?>" title="Unlike">Liked &nbsp; <span class="totalLikes"><?php echo getLikes($project['project_id']); ?></span></a>
                            <a href="#" class="project-action-btn" id="like_project" data-id="<?php echo $project['project_id'] ?>" style="display: none;">Like &nbsp;<span 
                           class="totalLikes"><?php echo getLikes($project['project_id']); ?></span></a>
                        <?php } else { ?>
                            <a href="#" class="project-action-btn" id="liked_project" data-id="<?php echo $project['project_id'] ?>" style="display: none;">Liked &nbsp;<span class="totalLikes"><?php echo getLikes($project['project_id']); ?></span></a>
