                    ...
                    <div class="content-title"><?php echo $user['display_name']; ?>
                        <div class="add-router">
                            ...
                            if (!$own_profile) {
                                ...
                                if ($status == -1) {
                                    ?>
                                    <a href="user.php?action=add_router&uid=<?php echo $uid; ?>"><img src="images/add_route.png" alt="" title="Click to add router"></a>
                                <?php } else if ($status == 1){
                                    ?>
                                    <a href="user.php?action=remove_router&uid=<?php echo $uid; ?>"><img src="images/routed.png" alt="" title="Click to remove router"></a>
                                    <?php
                                }
                                else if ($status == 0){
                                    ?>
                                    <a href="#"><img src="images/connection.png" alt="" title="Connection in Process"></a>
                                    <?php
                                }
                            }
                            ?>
        ...
        <?php } ?>
            ...
            <div class="project-bottom-details"><a href="upload.php?step=1&id='.$project[project_id].'" class="project-action-btn" style="width:100%; padding:0px 0px; border-radius: 0;">Edit Project</a></div>';} ?>
                ...
                <div class="my-activity content-block">
                    ...
                    <div id="home-tabs">
                        <ul>
                            <li><a href="includes/user-tab-activities.php?uid=<?php echo $_GET['uid']; ?>">Interactions</a></li>
                            <li><a href="includes/user-tab-commented.php?uid=<?php echo $_GET['uid']; ?>">Projects</a></li>
                            <li><a href="includes/user-tab-ideathread.php?uid=<?php echo $_GET['uid']; ?>">IdeaThreads</a></li>    
                ...
                <div class="footnote content-block">
                    ...
                    <div class="form-item no-height"><textarea name="footnote" id="footnote" maxlength="111"></textarea> <input type="submit" name="add_foonote" value="Add"></div>
