        ...
        <div class="main-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="content-block">
                    <div
                        class="content-title"><?php echo $user['display_name']; ?> <?php if ($user['verified'] == True) { ?>
                            ...
                            if (!$own_profile) {
                                ...
                                if ($status == -1) {
                                    ...
                                    <a href="<?php echo SITE_URL; ?>/user.php?action=remove_router&uid=<?php echo $uid; ?>"><img
                                            src="<?php echo SITE_URL; ?>/images/routed.png" alt=""
                                            title="Click to remove router"></a>
                                    <?php
                                } else if ($status == 0) {
                                    ?>
                    ...
                    <div class="content-left-col project-details">
                        <div class="user-photo">
                            ...
                            <div class="name-block"><a
                                    href="<?php SITE_URL . '/user.php?uid=' . $user['user_id']; ?>"><?php echo ucwords($user['display_name']); ?></a>
                            </div>
                        </div>
                    </div>
                            ...
                            foreach ($projects as $project) {
                                ...
                                <div class="recent-project-item">
                                    ...
                                    <div
                                        ...
                                        by <a
                                            href="<?php echo SITE_URL; ?>/user.php?uid=<?php echo $project['created_by']; ?>"><?php echo ucwords($user['display_name']); ?></a>
                                    </div>
                                    <?php if ($own_profile) {
                                        echo '
            <div class="project-bottom-details"><a href="upload.php?step=1&id=' . $project['project_id'] . '" class="project-action-btn" style="width:100%; padding:0px 0px; border-radius: 0;">Edit Project</a></div>';
                ...
                <div class="my-activity content-block">
                    ...
                    <div id="home-tabs">
                        <ul>
                            <li><a href="includes/user-tab-activities.php?uid=<?php echo $uid/*$_GET['uid']*/
                                ; ?>">Interactions</a>
                            </li>
                            <li>
                                <a href="includes/user-tab-commented.php?uid=<?php echo $uid/*$_GET['uid']*/
                                ; ?>">Projects</a>
                            </li>
                            <li><a href="includes/user-tab-ideathread.php?uid=<?php echo $uid/*$_GET['uid']*/
                                ; ?>">IdeaThreads</a>
                            </li>
                                ...
                                <div class="router-user-photo">
                                    <a href="user.php?uid=<?php echo $u['user_id']; ?>">
                                        ...
                                        <?php } else {
                                            ?>
                                            <img
                                                src="<?php echo SITE_URL; ?>/uploads/avatars/<?php echo $u['photo']; ?>"
                                                alt="">
                                        <?php } ?>
                                    </a>
