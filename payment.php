          ...
          Stripe.setPublishableKey('pk_test_46B48arrqMlpOhwxXGLXMS4I');
            $(document).ready(function() {
			   ...
			   function submit(form) {
					...
					if(amount == '' || amount == 0) { alert('Enter amount value'); return false; }
...
<form action="" method="post" id="card-payment">
<div class="content-title">Account Settings</div>
<div class="report-content-title">Rangeenroute Finance Account</div><br/>

<div class="form-item"><label>Available Balance:</label>$ <input type="text" name="college" value="<?php echo $balance; ?>"></div>
<hr class="delimiter standart">

<div class="content-left-col">
<div class="form-item"><label>Amount Due:</label>$ <input type="text" name="due_amount" value="<?php echo $monetize; ?>"></div>
<div class="form-item"><label>Due Date:</label>&nbsp;&nbsp; <input type="text" name="due_date" value="<?php echo $date; ?>"></div>
</div>
<div class="content-right-col">
    <div class="form-item"><br><input type="radio" name="payment_option" value="1" id="pay_account" disabled="disabled"><label for="pay_account" class="radio-label">Rangeenroute Finance Account</label></div>
<div class="form-item"><input type="radio" name="payment_option" value="2" id="pay_card" checked><label for="pay_card" class="radio-label">Debit or Credit Card</label></div>
</div>
...
<div class="content-left-col">
<div class="form-item"><label>Card Type:</label> <img src="images/icons/mastercard.png"> <img src="images/icons/visa.png"> <img src="images/icons/paypal.png"> <img src="images/icons/googlecheckout.png"> <img src="images/icons/amex.png"> <img src="images/icons/discover.png"></div>
<div class="form-item"><label>Name on Card:</label> <input type="text" ></div>
<div class="form-item"><label>Expiration:</label>
<select class="month" data-stripe="exp-month">
<option>Month</option>
<?php for ($i = 1; $i < 13; $i++) {
...
<select class="year" data-stripe="exp-year">
<option>Year</option>
...
<div class="content-right-col">
<div class="form-item"><label>Card Number:</label> <input type="text" size="20" data-stripe="number" class="card-number"></div>
<div class="form-item"><label>CVV:</label> <input type="text" size="4" data-stripe="cvc" class="card-cvc"></div>
<div class="form-item"><label>Zip Code:</label> <input type="text" name="zip_code"></div>
</div>
</div>
...
<div class="content-left-col">
<div class="form-item"><label>Name of user:</label> <input type="text" name="user_name"></div>
<div class="form-item"><label>Address of Billing:</label> <input type="text" name="billing_address"></div>
<div class="form-item"><label>Rangeenroute Acc. #:</label> <input type="text" name="billing_address"></div>
</div>

<div class="content-right-col">
<div class="form-item"><label>Available Balance:</label> $ <input type="text" name="available_balance" style="width:210px;"></div>
<div class="form-item"><label>Deduction Amount:</label> $ <input type="text" name="deduction_amount" style="width:210px;"></div>
</div>
</div>
